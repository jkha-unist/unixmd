    ...
    def evaluate_hop(self, qed, pol_list):
        ...
        if (self.l_hop):
            if (not qed.l_trivial):
                ...
                # Guard against vanishing pNAC: rescaling divides by 'a' which is ~|pnac|^2
                ...
                if (self.l_reject):
                    ...
                    if (self.hop_reject == "keep"):
                        ...
                        if (l_small_nac):
                            self.event["HOP"].append("Reject hopping: pNAC magnitude below threshold, velocity is not changed")
                        else:
